...
class AnomalyClassifier:
    ...
    def build_model(self, input_shape=(288, 6), classes_num=3):
        """
    ...
    def train_model(self, x_train, y_train, epochs, batch_size, shuffle, patience, verbose, num_classes=3):
        """
    ...
    def classify(self, signal_windows):
        ...
        """
        classification_results = self.model.predict(signal_windows, verbose=False)
